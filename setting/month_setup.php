...
if(isset($_GET['spid']) && $_GET['spid'] != ''){
		$result_location = mysqli_query($conn, "SELECT * FROM tbl_add_month_setup where m_id= '" . (int)$_GET['spid'] . "'");
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <table class="table sakotable table-bordered table-striped dt-responsive">
                ...
                <tbody>
                  <?php
				$result = mysqli_query($conn, "SELECT * FROM tbl_add_month_setup order by m_id ASC ");
