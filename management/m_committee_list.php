        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            <table class="table sakotable table-bordered table-striped dt-responsive">
              ...
              <tbody>
                <?php
				$result = mysqli_query($conn, "Select *,mt.member_type as mt_member_type from tbl_add_management_committee mc inner join tbl_add_member_type mt on mc.member_type = mt.member_id where mc.branch_id = " . (int)$_SESSION['objLogin']['branch_id'] . " order by mc.mc_id desc");
